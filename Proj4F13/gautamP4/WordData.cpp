//Title: Project 4 Worddata class and Implementation
//Author: Mahesh Gautam
//Description: This is the header file for WordData.cpp, It defines the WORDDARA Class,
...
//Default Constructor for WordData Class
WordData::WordData()
{
  word = new char [1];
  word[0] = '\0';
...
//Implementation of the copy constructor for WordData Class
...
//Boolean function to return true if vowels
...
//Implement the mutator function for SetWord
...
//Implement the accessor function for Getword
...
//Implemenatain of the input operator
