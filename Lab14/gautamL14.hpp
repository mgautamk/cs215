...
//This function inertd a value into a list if the value isn't there
//already
template <class ST>
...
//This function calls DeleteFirst and DeleteLast to delete
//values from a list
template <class ST>
...
//This is a union Operator, this combines values from two different
//list and puts them together
template <class ST>
