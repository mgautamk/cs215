...
//Date: Fall 2013
//File: LList2.hpp
//Other Files required: Lab13a.cpp or Lab13b.cpp or Lab13c.cpp
...
//This function moves through the list from left to right 
//i.e forward
template <class LT>
...
//This function moves throught the list right to left
//i.e backwards
template <class LT>
...
//This operator traverse through the list until it reaches the entry
// corresponding to the position int the index parameter. It then returns 
//the data Item in the selected entry
template <class LT>
...
//Increment Iterator operator with a interger reference
template <class LT>
...
//Deincrement Iterator operator with Integer reference
template <class LT>
typename LList2<LT>::Iterator LList2<LT>::Iterator::operator -- (int)
{
  Iterator temp = * this;
